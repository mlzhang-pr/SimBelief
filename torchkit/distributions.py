...
from torchkit.distributions import Distribution, Normal
class TanhNormal(Distribution):
    ...
    def __init__(self, normal_mean, normal_std, epsilon=1e-6):
        ...
        """
        normal_mean=torch.nan_to_num(normal_mean, nan=0.0,posinf=1e6, neginf=-1e6)
        normal_std=torch.nan_to_num(normal_std,nan=0.0,posinf=1e6, neginf=1e-6)
        normal_std[normal_std==0]=1e-6
