...
def get_args(rest_args):
    ...
    parser.add_argument('--task-embedding-size', type=int, default=50, help='dimensionality of latent space')  # defalt=5
    ...
    # similarity
    parser.add_argument('--use-similiarity', type=boolean_argument, default=True, help='use state decoder')
