...
def get_args(rest_args):
    ...
    # env
    parser.add_argument('--env-name', default='PandaPickAndPlace-v0', help='environment to train on')
    ...
    parser.add_argument('--num-iters', type=int, default=4000, help='number meta-training iterates')
