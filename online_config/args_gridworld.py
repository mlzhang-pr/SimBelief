...
def get_args(rest_args):
    ...
    # --- ENV ---
    parser.add_argument('--env-name', default='GridNavi-v2', help='environment to train on')
    parser.add_argument('--max-rollouts-per-task', type=int, default=4)
    parser.add_argument('--num-tasks', type=int, default=21, help='number of goals in environment')
    parser.add_argument('--num-train-tasks', type=int, default=16, help='number of tasks for train')
    ...
    parser.add_argument('--num-tasks-sample', type=int, default=5, help='number of tasks to collect rollouts per iter')  # 5 different tasks

    parser.add_argument('--num-iters', type=int, default=30000, help='number meta-training iterates')
    ...
    parser.add_argument('--num-rollouts-per-iter', type=int, default=5, help='number of rollouts to collect per task') # meta episodes
    ...
    # algo
    parser.add_argument('--policy', type=str, default='ddqn', help='choose: dqn, ddqn')
    ...
    parser.add_argument('--policy-lr', type=float, default=7e-5, help='learning rate for RL (default: 7e-5)')  ###
    parser.add_argument('--gamma', type=float, default=0.99, help='discount factor for rewards (default: 0.99)')

    parser.add_argument('--use-proper-time-limits', type=boolean_argument, default=False)

    parser.add_argument('--oracle-belief-rewards', type=boolean_argument, default=True,
                        help='whether to use oracle R+ in policy update')
    parser.add_argument('--switch-to-belief-reward', type=int, default=0,
