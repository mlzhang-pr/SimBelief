...
def get_args(rest_args):
    ...
    # --- ENV ---
    parser.add_argument('--env-name', default='PointRobotSparse-v0', help='environment to train on')
    ...
    parser.add_argument('--num-tasks-sample', type=int, default=5, help='number of tasks to collect rollouts per iter')  # default = 5
    ...
    parser.add_argument('--task-embedding-size', type=int, default=10, help='dimensionality of latent space')  # defalt 5-- 50   if z_dist 50, b_dist 25
    parser.add_argument('--aggregator-hidden-size', type=int, default=128,  # defalt 128  -256
    ...
    parser.add_argument('--state-pred-type', type=str, default='gaussian',
                        help='choose from: bernoulli, gaussian, deterministic')
    ...
    parser.add_argument('--log-interval', type=int, default=20,   #40  20  
