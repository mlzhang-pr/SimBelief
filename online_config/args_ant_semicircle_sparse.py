...
def get_args(rest_args):
    ...
    # env
    parser.add_argument('--env-name', default='AntSemiCircleSparse-v0', help='environment to train on')
    ...
    parser.add_argument('--num-init-rollouts-pool', type=int, default=5,     #  test 1 ; default==5
