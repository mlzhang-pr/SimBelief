...
class DQN(nn.Module):
    def __init__(self,
        ...
        # optimisers
        self.optimizer = optim.RMSprop(self.qf.parameters(), lr=lr, eps=eps_optim, alpha=alpha_optim)
        # self.optimizer = optim.Adam(self.qf.parameters(), lr=lr)
